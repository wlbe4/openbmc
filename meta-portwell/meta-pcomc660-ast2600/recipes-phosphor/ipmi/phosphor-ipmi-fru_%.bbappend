...
DEPENDS:append:pcomc660-ast2600 = " pcomc660-ast2600-yaml-config"
...
SYSTEMD_ENVIRONMENT_FILE_${PN}:append:pcomc660-ast2600 := " ${@compose_list(d, 'ENVFMT', 'EEPROMS')}"
...
SYSTEMD_LINK_${PN}:append:pcomc660-ast2600 := " ${@compose_list(d, 'FMT', 'EEPROMS_ESCAPED')}"
